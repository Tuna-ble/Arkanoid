...
public class VictoryLevelState implements GameState {
    ...
    public VictoryLevelState(int levelToRestart) {
        this.levelToRestart = levelToRestart;
        victoryGif = new Image("/GameIcon/victoryBackground.gif");

        // Initialize buttons
        restartButton = new Button(centerX - GameConstants.UI_BUTTON_WIDTH / 2, baseY + 0, "Resume");
