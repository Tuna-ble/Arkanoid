...
public class VictoryEndlessState implements GameState {
    ...
    public VictoryEndlessState(int levelToRestart) {
        this.levelToRestart = levelToRestart;
        victoryGif = new Image("/GameIcon/victoryBackground.gif");

        // Initialize buttons
        continueButton = new Button(centerX - GameConstants.UI_BUTTON_WIDTH / 2, baseY + 0, "Continue");
    ...
    private void updateButtons(I_InputProvider inputProvider) {
        if (continueButton != null) continueButton.update(inputProvider);
    ...
    public void render(GraphicsContext gc) {
        gc.drawImage(victoryGif, 0, 0, GameConstants.SCREEN_WIDTH, GameConstants.SCREEN_HEIGHT);
        ...
        // Các nút
        if (continueButton != null) continueButton.render(gc);
